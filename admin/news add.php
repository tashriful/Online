...
$sql = "INSERT INTO news (category , title , date , time , rep_name , main_news , photo) 
VALUES ('$category','$title','$date','$time','$repName','$desc','$target')";
	...
	include("includes/header.php");
       include("includes/sidebar.php");?>
        ...
        <div class="signup-form">
			...
			<h1><center>News Enter Form</center></h1>
			...
			Choose Category:
                ...
                <label>Title:</label>
				<br> 
                <input type="text" id="tit" onkeypress="success()" name="title" >
