...
include("includes/database.php");
                   $sql="select * from news where category='Bangladesh' order by news_id  limit 2";
...
if($data!=0){?>
    <h3><a href="categorynews.php?category=Bangladesh&&lim=0">Bangladesh</a></h3>
    <?php
 foreach($data as $v){
 ?>
    ...
    <?php
                $string =$v['title'];
                                         ...
                                         if (strlen($string) > $maxLength) 
                                         {
                                          ...
                                          ?>
    <h4><a href="singlenews.php?id=<?php echo $v['news_id'];?>">
                        <?php echo $string;?>...</a>
    </h4><br>
