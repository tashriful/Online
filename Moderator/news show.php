...
<div>
    ...
    <div style="background-color: #D8D8D8;height: 1000px;width: 70%;float: left;">
        ...
        <div style="background-color: #E8E8E8;height: 1000px;width: 97%;float: left;margin-left:2%; margin-top:2%;border:1px solid grey;">
		...
		?>
            ...
            <div style="margin-top:2%;margin-left:2%;margin-right:2%">
                <div style="background-color: #F5F5F5;height: 400px;width: 20%;float: left;">
                    <img style="width:100%;height:35%;" src="<?php echo $v['photo'];?>">
                </div>
                <div style="background-color: #F5F5F5;height: 400px;width: 78%;float: left;margin-left:1%;border:1px solid grey;">
                    <b><span style="font-size:25px;">
                            <?php echo $v['title'];?></span></b><br>
                    <span style="font-size:15px">Publish Date:
                        <?php echo $v['date'];?> &nbsp | &nbsp Publish time:
                        <?php echo $v['time'];?> &nbsp | Category:
                        <?php echo $v['category'];?></span><br><br>
                ...
                $string =$v['main_news'];
                    ...
                    <h3><a title="Edit" onclick="return confirm('Are you want to edit?');" href="newsedit.php?id=<?php echo $v['news_id'];?>">
                            Edit<i class="fa fa-edit"></i></button></a></h3>
                    <h3><a onclick="return confirm('Are you sure to Delete?');" href="newsdelete.php?id=<?php echo $v['news_id'];?>">Delete<i class="fa fa-trash-o"></i></a> </h3>
